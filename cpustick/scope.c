...
scope_initialize()
{
    ...
    g++; g++;                   // we seem to need a delay here to get the next line reliable!

    force_winusb = ! (PORTB & 0x0080);  // if pin a0(not AN0)/RB7 is grounded, force winusb instead of CDC/ACM for samsung phones
